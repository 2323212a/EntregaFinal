...
{
    public partial class Grado4 : Form
    {
        public Grado4()
        {
            InitializeComponent();
        ...
        public Grado4(string funcion) : this()
        {
        ...
        private void btnContinuar1_Click(object sender, EventArgs e)
        {
            ...
            // Crear instancia del formulario de soluciones
            Soluciones solForm = new Soluciones(lblResultado.Text, lblFuncionRecibida.Text,
